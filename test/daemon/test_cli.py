...
def test_daemon_status_includes_live_recorder_status(
    ...
    assert capsys.readouterr().out == (
        ...
        'details: active\n'
        'recording: active\n'
        'session directory: /recordings/-default-/2026/08/18/12-00-00\n'
        'record: /recordings/-default-/2026/08/18/12-00-00/session-record.jsonl\n'
        'disk: /recordings\n'
        'disk free bytes: 100\n'
...
class FakeRpcClient:
    ...
    def call(self, command: str) -> dict[str, object]:
        ...
        return {
            ...
            'session_directory': '/recordings/-default-/2026/08/18/12-00-00',
            'record_path': (
                '/recordings/-default-/2026/08/18/12-00-00/session-record.jsonl'
            ),
            'disk': {
                'path': '/recordings',
                'free_bytes': 100,
